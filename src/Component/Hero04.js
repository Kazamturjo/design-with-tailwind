...
const Hero04 = () => {
  return (
    <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 m-6 md:m-12 p-6 md:p-12'>
      ...
      <div className="w-full md:w-64 h-64 rounded-full overflow-hidden mx-auto ring-offset-8 ring-8 ring-red-500">
        <img
      ...
      <div className=''>
        <h1 className='text-4xl font-bold text-red-500 p-5 m-4'>2024</h1>
